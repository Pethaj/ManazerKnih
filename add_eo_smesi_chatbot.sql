-- SQL script pro přidání nového chatbota "EO-Smesi" do databáze
-- Spusťte tento script v Supabase SQL editoru
-- Nastavení je stejné jako u "Wany Chat", kromě webhook URL pro odpovědi

-- Přidání EO-Smesi chatbota
INSERT INTO public.chatbot_settings (
    ...
    (
        ...
        'https://n8n.srv980546.hstgr.cloud/webhook/20826009-b007-46b2-8d90-0c461113d263/chat', -- 🆕 Specifický webhook pro EO-Smesi
        true,   -- Aktivní
...
-- 🔍 POROVNÁNÍ: Zobraz EO-Smesi vedle Wany Chat pro kontrolu
SELECT 
    chatbot_id,
    chatbot_name,
    webhook_url,
